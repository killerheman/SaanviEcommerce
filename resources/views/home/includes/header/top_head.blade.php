    ...
    <div class="container">
        <div>
            <div class="topbar-text dropdown disable-autohide"><a class="topbar-link dropdown-toggle"
                    href="#" data-bs-toggle="dropdown"><img class="me-2" src="{{ asset('home/img/flags/en.png')}}"
                        width="20" alt="English">Eng / $</a>
                <ul class="dropdown-menu my-1">
                    ...
                    <li><a class="dropdown-item pb-1" href="#"><img class="me-2"
                                src="{{ asset('home/img/flags/fr.png')}}" width="20" alt="Français">Français</a></li>
                    <li><a class="dropdown-item pb-1" href="#"><img class="me-2"
                                src="{{ asset('home/img/flags/de.png')}}" width="20" alt="Deutsch">Deutsch</a></li>
                    <li><a class="dropdown-item" href="#"><img class="me-2"
                                src="{{ asset('home/img/flags/it.png')}}" width="20" alt="Italiano">Italiano</a></li>
                </ul>
            </div>
            <div
        ...
        <div class="topbar-text dropdown d-md-none ms-auto"><a class="topbar-link dropdown-toggle"
                href="#" data-bs-toggle="dropdown">Wishlist / Compare / Track</a>
